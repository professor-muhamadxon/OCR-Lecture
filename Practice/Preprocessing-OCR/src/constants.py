# --- 1. Belgilar va tovushlar ---
LETTERS = [
    'a', 'b', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l',
    'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'x',
    'y', 'z', 'ĝ', 'ô', 'ŝ', 'ĉ', 'ñ', 'ʼ',
    'а', 'б', 'д', 'э', 'ф', 'г', 'ҳ', 'и', 'ж', 'к', 'л',
    'м', 'н', 'о', 'п', 'қ', 'р', 'с', 'т', 'у', 'в', 'х',
    'й', 'з', 'ғ', 'ў', 'ш', 'ч', 'ӈ', 'ъ', 'ь'
]
...
KRILL_LETTERS = [
    'а', 'б', 'д', 'э', 'ф', 'г', 'ҳ', 'и', 'ж', 'к', 'л',
    'м', 'н', 'о', 'п', 'қ', 'р', 'с', 'т', 'у', 'в', 'х',
    'й', 'з', 'ғ', 'ў', 'ш', 'ч', 'ӈ', 'ъ', 'ь', 'е', 'ы', 'щ', 'ц', 'я', 'ю', 'ё', 'й', 'с'
]

VOWEL_LETTERS = ['a', 'e', 'i', 'o', 'u', 'ô', 'а', 'э', 'и', 'о', 'у', 'ў']
CONSONANT_LETTERS = [l for l in LETTERS if l not in VOWEL_LETTERS and l != 'ʼ']
